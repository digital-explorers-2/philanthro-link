...
<p className="mb-10 font-normal md:text-lg leading-7 justify-par">At PhilanthroLink, we believe in the power of community and collaboration. Our platform offers a seamless and secure way for individuals and organizations to support verified charitable projects that make a real difference.
